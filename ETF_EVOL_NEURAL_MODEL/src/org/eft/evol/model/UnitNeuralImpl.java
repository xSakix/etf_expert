...
// }
//
// public void appendHistory(int it, int cycle, Map<Integer, Float>
// etfValueMap){
//
...
//
// int index = etfValueMap.keySet().toArray(new Integer[]
// {})[Uniform.staticNextIntFromTo(0, etfValueMap.keySet().size()-1)];
...
// return "[["+ID+"],null,"+ Arrays.toString(preference) +",[" + cash + "]," +
// etfs.toString()+"]";
// }
//
// @Override
...
// StandardOpenOption.APPEND);
//// }
// Files.write(historyLogFile.toPath(), currentState.toString().getBytes(),
// StandardOpenOption.APPEND);
// } catch (IOException e) {
// e.printStackTrace();
// }
