...
import org.eft.evol.preference.UnitWithoutPreference;
...
public class WithoutPreferenceMain
{
    ...
    {
	WithoutPreferenceMain preferenceMain = new WithoutPreferenceMain();
	preferenceMain.run();
    }
	...
	for (int i = 0; i < POPULATION_SIZE; i++)
	{
	    ...
	    units.add(new UnitWithoutPreference(loadedETFS.size(),
    ...
    {
	return new UnitWithoutPreference(UnitSequenceGenerator.getID(),
