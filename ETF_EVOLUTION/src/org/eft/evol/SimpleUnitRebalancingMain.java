...
public class SimpleUnitRebalancingMain
{
    ...
    private static final int REBALANCE_PERIOD = 180;
	...
	while (true)
	{
		...
		if (cycle % REBALANCE_PERIOD == 0)
		{
		    ...
		    final float inv = investment;
		    population.parallelStream().forEach(u -> {
			u.cash = inv;
			u.initShares();
			;
		    });
