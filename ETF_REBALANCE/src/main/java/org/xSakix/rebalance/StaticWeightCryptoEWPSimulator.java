...
public class StaticWeightCryptoEWPSimulator {
    ...
    public StaticWeightCryptoEWPSimulator(double[][] data, double[] w) {
...
//            boolean rebalance = (i % 30 == 0);
    ...
    @Override
    public StaticWeightCryptoEWPSimulator clone() throws CloneNotSupportedException {
        StaticWeightCryptoEWPSimulator individual = new StaticWeightCryptoEWPSimulator(this.data,this.w);
