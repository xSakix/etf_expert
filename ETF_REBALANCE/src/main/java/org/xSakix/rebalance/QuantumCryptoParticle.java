...
public class QuantumCryptoParticle {
    ...
    public QuantumCryptoParticle(double[][] in_data) {
        init(in_data);
    }
    ...
    public double evaluate(){
        WeightedDailyCryptoEWPSimulator simulator = new WeightedDailyCryptoEWPSimulator(in_data,w);
        double result =  simulator.evaluate();
        this.k = Arrays.copyOf(simulator.getK(),simulator.getK().length);
        return result;
    }
    ...
    @Override
    public QuantumCryptoParticle clone() throws CloneNotSupportedException {
        QuantumCryptoParticle individual = new QuantumCryptoParticle(in_data);
    ...
    public static void main(String[] args) throws IOException, CloneNotSupportedException {
        ...
        while (true) {
            ...
            for(QuantumCryptoParticle particle : particles){
        ...
        WeightedDailyCryptoEWPSimulator simulator = new WeightedDailyCryptoEWPSimulator(in_data,best.getW());
        double result = simulator.evaluate();
        ...
        WeightedDailyCryptoEWPSimulator finalBest = simulator;
        ...
        double sum = Arrays.stream(simulator.getK()).sum();
        long count = Arrays.stream(simulator.getK()).filter(v -> v > 0.).count();
        ...
        plot6.addLinePlot("% development",Color.red,simulator.getK());
        plot6.addLegend("SOUTH");
