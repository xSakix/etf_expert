...
public class WeightedDailyCryptoEWPSimulator {
    ...
    public WeightedDailyCryptoEWPSimulator(double[][] data, double[] w) {
        this.w = Arrays.copyOf(w,w.length);
        this.data = data;
        M = data.length;
        this.k = new double[w.length];
...
//            boolean rebalance = (i % 30 == 0);
    ...
    @Override
    public WeightedDailyCryptoEWPSimulator clone() throws CloneNotSupportedException {
        WeightedDailyCryptoEWPSimulator individual = new WeightedDailyCryptoEWPSimulator(this.data,this.w);
...
//        WeightedDailyCryptoEWPSimulator best = null;
...
//                WeightedDailyCryptoEWPSimulator simulator = new WeightedDailyCryptoEWPSimulator(in_data_test);
...
//        WeightedDailyCryptoEWPSimulator finalBest = best;
