...
//
// while(max > 0 ){
// int index = etfValueMapKeySet.toArray(new Integer[]
// {})[Uniform.staticNextIntFromTo(0, etfValueMapKeySet.size()-1)];
...
// while(true){
//
// int index = etfs.keySet().toArray(new
// Integer[]{})[Uniform.staticNextIntFromTo(0, etfs.keySet().size()-1)];
//
