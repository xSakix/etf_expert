...
// extends AbstractUnit implements Unit {
//
...
// }
//
// public UnitSigmoidImpl(int index, float[] character, Map<Integer,Float>
// preference) {
...
// int indexChoice = Uniform.staticNextIntFromTo(0, etfValueMapKeySet.size() -
// 1);
// Integer chosenIndex = etfValueMapKeySet.toArray(new Integer[]
// {})[indexChoice];
...
// if (Math.abs(((float) index) - result) < ERROR_TOLERANCE &&
// etfValueMapKeySet.contains(index - 1)) {
// return index - 1;
// }
// }
//
...
//
// @Override
// public boolean buy(int iteration, int cycle, List<Map<Integer, Float>>
// etfValueMap) {
//
...
// }
//
// private boolean doBuyAction(int iteration, int cycle, List<Map<Integer,
// Float>> etfValueMap, int index, float nav) {
// if (cash < nav) {
// return false;
// }
//
...
//
// @Override
// public boolean sell(int iteration, int cycle, List<Map<Integer, Float>>
// etfValueMap) {
//
...
// }
//
// private boolean doSellAction(int iteration, int cycle, List<Map<Integer,
// Float>> etfValueMap, int index, float nav) {
...
//
// Map<Integer, Float> nPreference =
// crossoverPreference(other,buyPreference,ActionType.BUY);
//
// return new UnitSigmoidImpl(UnitSequenceGenerator.getID(), nCharacter,
// nPreference);
// }
//
// @Override
...
//
// @Override
// protected void addGradientToAction(int cycle, List<Map<Integer, Float>>
// etfValueMap, UnitAction sellAction) {
...
//
// @Override
// public void performAction(List<Map<Integer, Float>> navValues, int it, int
// cycle) {
// boolean actionPerformed = false;
//
// if(Math.abs(ActionType.HOLD -
// ActionType.HOLD*sigmoid(100.0f*character[INDEX_HOLD] + sumGradient)) <
// ERROR_TOLERANCE){
// hold(it, cycle, navValues);
// return;
// }
//
// if(Math.abs(ActionType.SELL -
// ActionType.SELL*sigmoid(100.0f*character[INDEX_BUY] + sumGradient)) <
// ERROR_TOLERANCE){
// actionPerformed = sell(it, cycle, navValues);
// }
//
// if(Math.abs(ActionType.BUY -
// ActionType.BUY*sigmoid(100.0f*character[INDEX_SELL] + sumGradient)) <
// ERROR_TOLERANCE){
