...
public class UnitWithoutPreference extends AbstractPreferenceUnit implements PreferenceUnit {

	public UnitWithoutPreference(int ETF_SIZE, int index) {
		super(ETF_SIZE, index);
	}

	public UnitWithoutPreference(int index, float[] character, float[] preference) {
	...
	public PreferenceUnit crossOver(PreferenceUnit other) {
		...
		return new UnitWithoutPreference(UnitSequenceGenerator.getID(), nCharacter, nPreference);
	}

	@Override
	public String toString() {
		return "UnitWithoutPreference " + super.toString();
	}

	@Override
	protected String currentStateString() {
		return "UnitWithoutPreference " + super.currentStateString();
	}

	@Override
	public String getDir(int iteration) {
		return iteration+"_UnitWithoutPreference";
	}
