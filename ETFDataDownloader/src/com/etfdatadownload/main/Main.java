...
//				Files.delete(dataFile);
			...
			dataFile = Paths.get(dir.toString() + "\\" + currencyDirectory + "_div", ticket + ".csv");

			Files.createDirectories(Paths.get(dir.toString() + "\\" + currencyDirectory + "_div"));
			...
			try {
				data = downloader.downloadDiv(params);
			} catch (IOException e) {
				e.printStackTrace();
			} catch (Exception e) {
				// TODO Auto-generated catch block
