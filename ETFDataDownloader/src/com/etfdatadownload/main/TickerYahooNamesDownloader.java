...
public class TickerYahooNamesDownloader {
	...
	//private static final String URL = "http://finance.yahoo.com/lookup/etfs?s=1&t=E&m=ALL&b=%d";
	...
	public static String loadAllSymbolNamesFromYahoo() throws MalformedURLException, IOException, InterruptedException{
		...
		//System.out.println(IOUtils.toString(new java.net.URL(String.format(URL, 0)),"UTF-8"));
